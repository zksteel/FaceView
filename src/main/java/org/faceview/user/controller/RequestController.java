...
public class RequestController {
    ...
    public String newRequestAction(@RequestBody @Valid FriendRequestModel friendRequestModel){
    ...
    public ResponseEntity acceptFriendRequest(@RequestBody @Valid FriendRequestModel friendRequestModel){
    ...
    public ResponseEntity declineFriendRequest(@RequestBody @Valid FriendRequestModel friendRequestModel){
